...
"Ex_Planta_Planilla_Detalle_FINAL" AS 
    (
    SELECT
...
SELECT
    ...
    "D1"."C3" AS "Concepto2", 
    "D1"."C4" AS "Fecha", 
    SUM("D1"."C7") AS "Valor_USD_m3", 
    MAX("D1"."C8") AS "TC", 
    SUM("D1"."C9") AS "Valor", 
    "D1"."C5" AS "Dia", 
    SUM("D1"."C10") AS "Orden", 
    SUM("D1"."C11") AS "Decimales", 
    SUM("D1"."C12") AS "Densidad", 
    "D1"."C6" AS "Orden1"
FROM
    (
    SELECT
        "Ex_Planta_Planilla_Detalle_FINAL"."Año" AS "C0", 
        "Ex_Planta_Planilla_Detalle_FINAL"."Numero" AS "C1", 
        "Ex_Planta_Planilla_Detalle_FINAL"."Producto" AS "C2", 
        "Ex_Planta_Planilla_Detalle_FINAL"."Concepto2" AS "C3", 
        "Ex_Planta_Planilla_Detalle_FINAL"."Fecha" AS "C4", 
        "Ex_Planta_Planilla_Detalle_FINAL"."Dia" AS "C5", 
        CASE "Ex_Planta_Planilla_Detalle_FINAL"."Concepto2"
            WHEN 'Precio de Venta al Público (PVP) (impuestos incluidos)' THEN 1
            WHEN 'Margen de distribución de GLP envasado' THEN 2
            WHEN 'Tasa URSEA etapa venta al público' THEN 3
            WHEN 'IVA etapa venta al público' THEN 3.1
            WHEN 'Precio Intermedio Transitorio (PIT) (impuestos incluidos)' THEN 4
            WHEN 'Bonificación estaciones de servicio' THEN 2
            WHEN 'Tasa URSEA etapa venta al público' THEN 3
            WHEN 'IVA etapa venta al público' THEN 4
            ...
            WHEN 'PPI sin tasas e impuestos' THEN 27
            WHEN 'PEP calculado por URSEA (*)' THEN 27
            WHEN 'Monto diferencial por zonas "d"' THEN 28
            WHEN 'PPI n-1 Periodo URSEA' THEN 29
            WHEN 'PPI n-2 Periodo URSEA' THEN 30
            ELSE 28
        END AS "C6", 
        CASE 
            WHEN 
                "Ex_Planta_Planilla_Detalle_FINAL"."Producto" IN ( 
                    'Butano Desodorizado', 
                    'Supergas', 
                    'Supergas A Granel', 
                    'Propano', 
                    'Propano Industrial' )
                THEN
                    "Ex_Planta_Planilla_Detalle_FINAL"."Valor_USD_m3" * "Densidades"."Densidad"
            ELSE "Ex_Planta_Planilla_Detalle_FINAL"."Valor_USD_m3"
        END AS "C7", 
        "Ex_Planta_Planilla_Detalle_FINAL"."TC" AS "C8", 
        "Ex_Planta_Planilla_Detalle_FINAL"."Valor" AS "C9", 
        "Ex_Planta_Planilla_Detalle_FINAL"."Orden" AS "C10", 
        "Ex_Planta_Planilla_Detalle_FINAL"."Decimales" AS "C11", 
        "Densidades"."Densidad" AS "C12"
    FROM
        "Ex_Planta_Planilla_Detalle_FINAL"
            INNER JOIN "Densidades"
            ON 
                "Ex_Planta_Planilla_Detalle_FINAL"."Año" = "Densidades"."pAño" AND
                "Ex_Planta_Planilla_Detalle_FINAL"."Numero" = "Densidades"."Número" AND
                "Ex_Planta_Planilla_Detalle_FINAL"."Producto" = "Densidades"."Producto"
    ) "D1" 
GROUP BY 
    "D1"."C0", 
    "D1"."C1", 
